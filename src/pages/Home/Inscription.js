...
function Inscription() {
    ...
    const [adressMail, setAdressMail] = useState('');
                ...
                <Col xs={12} md={3}>
                    <Form >
                        <Form.Group className="mb-3" controlId="formBasicName">
                            ...
                            <Form.Control type="name" placeholder="Entrez votre nom" value={userName} onChange={(e) => setUserName(e.target.value)} />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicName">
                            <label>Entrez Votre prenom</label>
                            <Form.Control type="name" placeholder="Entrez Votre prenom" value={lastName} onChange={(e) => setLastName(e.target.value)} />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicName">
                ...
                <Col xs={12} md={3}>
                    <Form>
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Control type="email" placeholder="Entrez votre email" value={adressMail} onChange={(e) => setAdressMail(e.target.value)} />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3" controlId="formBasicPassword">
                            ...
                            <Form.Control type="password" placeholder="Confirmez votre Mot de passe" value={confirmPass} onChange={(e)=>setConfirmPass(e.target.value)} />
